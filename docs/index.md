---
title: PakePlus - Turn Web into Desktop/Mobile Apps in Minutes
description: Free open source tool to package HTML/Web/Vue/React projects into cross-platform desktop and mobile apps. Smaller than Electron, faster performance, supports Windows/macOS/Linux/Android/iOS.
layout: home
---
...
actions: - theme: brand
text: Guide
link: /guide/ - theme: brand
text: WebBeta
link: https://PakePlus.netlify.app/ - theme: brand
text: Download
link: /download/

features: - title: Open Source
...
icon: 👩🏿‍💻 - title: Internationalization
