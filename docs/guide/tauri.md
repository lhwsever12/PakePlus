---
title: Advanced Configuration - Desktop Window Settings
description: Advanced Tauri window configuration for PakePlus desktop apps. Customize window size, transparency, fullscreen, always-on-top, and more.
---
