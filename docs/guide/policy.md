...
If we discover that we have collected children's personal information without prior verifiable parental consent, we will endeavor to delete the relevant data as soon as possible.
