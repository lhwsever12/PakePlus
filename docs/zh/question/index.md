---
title: PakePlus 常见问题 FAQ - 问题自查与解决
description: PakePlus 常见问题汇总，包括应用已损坏、无法拖拽、打包后白屏、窗口跳转等问题的解决方案。
---
...
8. 平板电脑是什么系统，就打包对应系统的包，就可以了，一些安卓电视系统可能版本较低不兼容
...
当遇到网络问题，可以点击网络测速看一下，如果报绿色说明成功，如果报红色 timeOut 说明你的网络服务商把 github 的接口地址屏蔽了，请科学上网或者换一个网络服务商。或者关掉所有杀毒软件！群里就有人遇到过这种情况，然后关掉杀毒软件就好了。顺便说一句：360 等流氓软件就不要用了，不但会监控你的电脑，还会上报你的浏览信息，这是非常不道德的行为。

![](../../static/imgs/fixbug2.webp)
...
可能项目是在填入 token 之前创建的，或者是开通权限之前创建的，这个时候需要删除老项目，在权限页面 -> 点击更新修复按钮，然后重新创建项目，再进行发布，这样就可以解决问题了。

![](../../static/imgs/fixbug1.webp)

## rerun cancel and rerun count

这个大概率是 github 工作流异常导致的，需要及时修复代码才可以，理论上我们会及时修复。将 PakePlus 更新到最新版本，然后删除所有老项目，重新 token 登录或者 github 授权登录或点击更新修复按钮，然后重新创建项目，再进行发布，这样就可以解决问题了

![](../../static/imgs/fixbug1.webp)

## 大部分发布失败或卡住不动的解决办法

将 PakePlus 更新到最新版本，然后删除所有老项目，重新 token 登录或者 github 授权登录或点击更新修复按钮，然后重新创建项目，再进行发布，这样就可以解决问题了
